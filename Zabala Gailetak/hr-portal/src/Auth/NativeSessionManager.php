...
/**
 * Native PHP Session Manager (Zero Trust Fallback)
 *
 * Replaces Redis Session Manager when Redis is not available (e.g., InfinityFree).
 * Uses standard PHP $_SESSION mechanism.
 */
