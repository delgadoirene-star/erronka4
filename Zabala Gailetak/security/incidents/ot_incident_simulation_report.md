...
Erasotzaile batek (Red Team) bulegoko saretik (IT) produkzio sarera (OT) jauzi egitea lortu zuen, gaizki konfiguratutako ingeniaritza-estazio bat erabiliz (Dual-homed PC: bi sareetara konektatuta zegoen ekipoa). Erasotzaileak `Modbus` komandoak bidali zizkion labeko PLCari tenperatura arriskutsu batera igotzeko.
